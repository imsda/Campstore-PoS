...
async function submitCheckout(){
  ...
  const payload={saleType,camperId:selected?.id,cart,allowOverride:false,clientRequestId:'sale_'+currentMillis()+'_'+Math.random().toString(16).slice(2)}; if(saleType==='cash') payload.cashReceivedCents=rec.cents;
